...
A collection of AI agent skills for knowledge management, research, and productivity. Compatible with **OpenClaw**, **Hermes**, and any agent framework that supports SKILL.md.
...
| Component | OpenClaw | Hermes | Other Agents |
|-----------|----------|--------|-------------|
| SKILL.md | Native | Native | N/A |
| Python scripts | Via shell_exec | Via shell_exec | Direct execution |
...
Skills should:
1. Include `SKILL.md` for OpenClaw/Hermes compatibility
